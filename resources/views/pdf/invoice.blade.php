...
<header>
    ...
    <address contenteditable>
        <img alt="Logo" src="img/main-logo.png">
        <p>{{$user_name}}</p>
        <p>Company: {{$user_business}}</p>
        <p>{{$user_email}}</p>
    </address>
</header>
<article>
    <h1>Recipient</h1>
    <address contenteditable>
        <p>{{$client_name}}<br>{{$client_location}}<br>{{$client_number}}</p>
    </address>
    <table class="meta">
        <tr>
        ...
        <tr>
            ...
            <td><span contenteditable>{{$invoice_date}}</span></td>
        </tr>
        <tr>
            <th><span contenteditable>Amount Due</span></th>
            <td><span id="prefix" contenteditable>$</span><span>{{$total_due}}.00</span></td>
        </tr>
    </table>
    ...
    <table class="balance">
        <tr>
            ...
            <td><span data-prefix>$</span><span>{{$total_due}}.00</span></td>
        </tr>
        <tr>
