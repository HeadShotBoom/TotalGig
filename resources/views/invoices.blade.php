        ...
        <div>
            <table class="large-table">
                ...
                <tr class="content" data-id={{ $invoice->id }}<!-- INSERT INVOICE ID HERE -->
                    ...
                    <td class="paid"><a href="/invoices/{{ $invoice->id }}/toggle">{{ $invoice->paid }}</a></td> <!-- This link should go to a function that updates the gig as the opposite of what it currently displays. I.E. if the invoice is not paid, 												  the link should take it to a function that updates it to paid and vice versa. -->
