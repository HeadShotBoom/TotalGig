...
<p>This is a contract entered into by {{ $data['user_name'] }} of {{ $data['user_business'] }} (hereinafter referred to as "the Provider") and {{ $data['client_name'] }} (hereinafter referred to as "the Client") on this date, {{ $data['created_date'] }} .</p>
