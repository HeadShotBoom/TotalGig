...
Route::get('gigs/contract/{id}/download', 'GigController@downloadContract');
Route::get('gigs/contract/{id}/print', 'GigController@printPdf');
Route::get('gigs/contract/{id}/toggle', 'GigController@toggleContract');
